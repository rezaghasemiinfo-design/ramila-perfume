      ...
      <div className="max-w-7xl mx-auto h-20 px-4 md:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          ...
          <Link
            href="/cart"
            aria-label="سبد خرید"
            className="relative text-[#173F2E] hover:text-[#9A8456] transition"
          >
            <ShoppingBag size={25} strokeWidth={1.8} />

            {itemCount > 0 && (
              <span className="absolute -top-2 -left-2 min-w-[18px] h-[18px] px-1 rounded-full bg-[#9A8456] text-white text-[10px] font-bold flex items-center justify-center">
